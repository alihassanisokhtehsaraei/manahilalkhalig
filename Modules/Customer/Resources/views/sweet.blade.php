...
<div class="page-wrapper" id="pageWrapper">
    ...
    <div class="page-main-header">
        <div class="main-header-right row m-0">
            <div class="main-header-left">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('theme/viho/assets/images/logo/logo.png') }}" alt=""></a></div>
                <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('theme/viho/assets/images/logo/dark-logo.png') }}" alt=""></a></div>
            ...
            <div class="nav-right col pull-right right-menu p-0">
                <ul class="nav-menus">
                    <li><a class="text-dark" href="sweet-alert2.html#!" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
                    ...
                    <li class="onhover-dropdown"><i data-feather="message-square"></i>
                        <ul class="chat-dropdown onhover-show-div">
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{ asset('theme/viho/assets/images/user/4.jpg') }}" alt="">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{ asset('theme/viho/assets/images/user/1.jpg') }}" alt="">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{ asset('theme/viho/assets/images/user/2.jpg') }}" alt="">
    ...
    <div class="page-body-wrapper horizontal-menu">
        ...
        <header class="main-nav">
            <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{ asset('theme/viho/assets/images/dashboard/1.png') }}" alt="">
...
<script src="{{ asset('theme/viho/assets/js/sweet-alert/app.js') }}"></script>
<script src="{{ asset('theme/viho/assets/js/tooltip-init.js') }}"></script>
<!-- Plugins JS Ends-->
<!-- Theme js-->
<script src="{{ asset('theme/viho/assets/js/script.js') }}"></script>
<script src="{{ asset('theme/viho/assets/js/theme-customizer/customizer.js') }}"></script>
<!-- login js-->
<!-- Plugin used-->
</body>
</html>
