        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <h3>Tracking No.: {{ $coc->order->tracking_no }}</h3>
                    <ol class="breadcrumb">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="bookmark">
                        <ul>
                            <li><a href="{{ route('coc.Goods', $coc->order_id) }}" data-container="body" data-bs-toggle="popover" data-placement="top" title="BACK" data-original-title="call"><i data-feather="chevron-left"></i></a></li>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5>COC Goods Profile</h5><span>Please fill all required inputs.</span>
                        </div>
                        <form class="theme-form" method="post" action="{{ route('coc.updateGoods', Request::segment(3)) }}" id="ic">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="quantity" value="{{ $cocgood->quantity }}" name="quantity" required >
                                        </div>


                                        <div class="form-group">
                                            <label for="value">Goods Value:</label>
                                            <input type="text" class="form-control" id="value" value="{{ $cocgood->value }}" name="value" required >
                                        </div>


                                        <div class="form-group">
                                            <label for="origin">Origin as marked on goods:</label>
                                            <input type="text" class="form-control" id="origin"  value="{{ $cocgood->origin }}" name="origin" required >
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="standard" value="{{ $cocgood->standard }}" name="standard" required >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="type" name="type" required >
                                                <option value="{{ $cocgood->type }}">{{ $cocgood->type }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Enter ..." name="desc" id="desc" required >{{ $cocgood->desc }}</textarea>
                                        </div>
