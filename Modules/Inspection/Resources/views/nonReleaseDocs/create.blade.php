...
@section('body')
    <div class="custom-form-container p-3 m-3">
        <form action="{{ route('nrdocs.store', ['order' => $order]) }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            @csrf
            <div class="col-md-12">
                <br>
...
• Check the condition of the shipment (no damage of overall containers,(no damage of goods and ensuring that the chilled or frozen goods are in refrigerate containers).') }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group custom-form-group">
                            <label for="shipment_details" class="custom-label"><strong>Shipment details:</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    <label for="total_quantity" class="custom-label"><strong>Total Quantity:</strong></label>
                                    <input type="number" readonly name="total_quantity" class="custom-input"  value="{{ $order->container }}" id="total_quantity" style="text-align:center">
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    <label for="incoming_quantity" class="custom-label"><strong>Incoming Quantity:</strong></label>
                                    <input type="number" name="incoming_quantity" id="incoming_quantity" class="custom-input" style="text-align:center">
                            ...
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    <label for="remaining_quantity" class="custom-label"><strong>Remaining Quantity:</strong></label>
                                    <input type="number" readonly name="remaining_quantity" id="remaining_quantity" class="custom-input" style="text-align:center" value="{{ $order->container - $order->releaseDocuments->map(fn($doc) => $doc->incoming_quantity)->sum() }}">
                                </div>
                            </div>
                        </div>
                ...
                <input type="submit" style="float:right" class=" mb-3 btn btn-primary custom-submit-button" name="submit" value="Submit">
            </div>
        </form>
    </div>
@endsection
