...
@section('body')
    <div class="custom-form-container p-3 m-3">
        ...
        <div class="back-button-container">
            <a href="{{ route('nrdocs.index', ['order' => $order]) }}" class="back-button">
                Back
            </a>
        </div>
        <form action="{{ route('nrdocs.update', ['order' => $order,'nonReleaseDocument'=>$nonReleaseDocument]) }}"
            ...
            <div class="col-md-12">
                ...
                <div class="form-group custom-form-group">
                    ...
                    <textarea class="form-control custom-textarea" rows="8" name="description"
                              id="description"
                              required {{$readOnly}}>{{$nonReleaseDocument->description}}</textarea>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group custom-form-group">
                            ...
                            <textarea class="form-control custom-textarea" rows="3" placeholder="Enter ..."
                                      ...
                                      id="containers_details_not_mentioned" {{$readOnly}}>{{$nonReleaseDocument->containers_details_not_mentioned}}</textarea>
                        </div>
                        ...
                        <div class="form-group custom-form-group">
                            ...
                            <textarea class="form-control custom-textarea" rows="3" placeholder="Enter ..."
                                      ...
                                      id="import_documents_not_mentioned" {{$readOnly}}>{{$nonReleaseDocument->import_documents_not_mentioned}}</textarea>
                        </div>
                        ...
                        <div class="form-group custom-form-group">
                            ...
                            <textarea class="form-control custom-textarea" rows="3" placeholder="Enter ..."
                                      ...
                                      id="number_of_items" {{$readOnly}}>{{$nonReleaseDocument->number_of_items}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group custom-form-group">
                            ...
                            <select class="form-control custom-select" name="shipment_type"
                                ...
                                <option value="Full Container" {{$nonReleaseDocument->shipment_type === "Full Container" ? "selected" : ""}}>
                                    Full Container
                                </option>
                                <option value="Partial Container" {{$nonReleaseDocument->shipment_type === "Partial Container" ? "selected" : ""}}>
                                    Partial Container
                                </option>
                                <option value="Trucks" {{$nonReleaseDocument->shipment_type === "Trucks" ? "selected" : ""}}>
                                    Trucks
                                </option>
                                <option value="Packages" {{$nonReleaseDocument->shipment_type === "Packages" ? "selected" : ""}}>
                                    Packages
                                </option>
                            </select>
                            @if($readOnly)
                                <input type="hidden" name="shipment_type" value="{{ $nonReleaseDocument->shipment_type }}">
                            @endif
                        </div>
                        <div class="form-group custom-form-group">
                            ...
                            <select class="form-control custom-select" name="shipment_details"
                                ...
                                <optgroup label="Select one">
                                    <option value="Complete" {{$nonReleaseDocument->shipment_details === "Complete" ? "selected" : ""}}>
                                        Complete
                                    </option>
                                    <option value="Partial" {{$nonReleaseDocument->shipment_details === "Partial" ? "selected" : ""}}>
                                        Partial
                                    </option>
                                </optgroup>
                            </select>
                            @if($readOnly)
                                <input type="hidden" name="shipment_details" value="{{ $nonReleaseDocument->shipment_details }}">
                            @endif
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="number" name="total_quantity"
                                           value="{{ $nonReleaseDocument->total_quantity }}" class="custom-input"
                            ...
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="number" name="incoming_quantity"
                                           value="{{ $nonReleaseDocument->incoming_quantity }}" id="incoming_quantity"
                            ...
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="number" name="remaining_quantity"
                                           ...
                                           value="{{ $nonReleaseDocument->remaining_quantity}}"
                                           class="custom-input" style="text-align:center"  readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group custom-form-group">
                            ...
                            <textarea class="form-control custom-textarea" rows="3" placeholder="Enter ..."
                                      name="comments"
                                      id="comments" {{$readOnly}}>{{$nonReleaseDocument->comments}}</textarea>
                        </div>
                    </div>
                </div>
...
@section('moreJs')
    <script>
        ...
        function calculateRemainingQuantity() {
            ...
            let sumPreviousIncoming = {{ $order->releaseDocuments->map(fn($doc) => $doc->incoming_quantity)->sum() + $order->nonReleaseDocuments->map(fn($doc) => $doc->incoming_quantity)->sum() - $nonReleaseDocument->incoming_quantity }};
