        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <h3>Edit Request of Testing: {{ $rft->id }}</h3>
                    <ol class="breadcrumb">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="applicationType" id="applicationType">
                                                    @if($rft->order_id)
                                                        <option value="RFI: {{ $rft->order->tracking_no }}">RFI: {{ $rft->order->tracking_no }}</option>
                                                    @else
                                                        <option value="{{ $rft->applicationType }}">{{ $rft->applicationType }}</option>
                                                    @endif
...
{{--                                                <input class="form-control" name="rfc" id="rfc" type="number" value="{{ $rft->rfc }}">--}}
{{--                                            </div>--}}
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="office" id="office">
                                                    <option value="{{ $rft->office }}">{{ $rft->office }}</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="lab" id="lab">
                                                    <option value="{{ $rft->lab }}">{{ $rft->lab }}</option>
                                                        <optgroup label="Sea Ports" style="font-weight:bold;">Sea Ports
                                                            <option value="North Umm Al-Qasr Port">North Umm Al-Qasr Port</option>
                                                            <option value="Middle Umm Al-Qasr Port">Middle Umm Al-Qasr Port</option>
                                                            <option value="South Umm Al-Qasr Port">South Umm Al-Qasr Port</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"  class="form-control" name="applicantName" id="applicantName" value="{{ $rft->applicantName ?? $customer->cName }}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="applicantAddress">Applicant Address:</label>
                                                <textarea class="form-control" name="applicantAddress" id="applicantAddress" rows="5">{{ $rft->applicantAddress ?? $customer->address }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="applicantContact">Applicant Contact Person:</label>
                                                <input type="text"  class="form-control" name="applicantContact" id="applicantContact"  value="{{ $rft->applicantContact ?? $customer->fullName }}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="exporterEmail">Applicant Email:</label>
                                                <input type="text"  class="form-control" name="applicantEmail" id="applicantEmail"  value="{{ $rft->applicantEmail ??  $customer->email }}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="applicantTel">Applicant Phone No.:</label>
                                                <input type="text"  class="form-control" name="applicantTel" id="applicantTel"  value="{{ $rft->applicantTel ?? $customer->tel }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="payerName">Payer Name:</label>
                                                <input type="text"  class="form-control" name="payerName" id="payerName"  value="{{ $rft->payerName ?? $customer->cName }}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="payerAddress">Payer Address:</label>
                                                <textarea class="form-control" name="payerAddress" id="payerAddress" rows="5" >{{ $rft->payerAddress ?? $customer->address }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="payerContact">Importer Contact Person:</label>
                                                <input type="text"  class="form-control" name=payerContact" id="payerContact"  value="{{ $rft->payerContact ?? $customer->fullName }}">
                                            </div>
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0" for="payerEmail">Importer Email:</label>
                                                <input type="text"  class="form-control" name="payerEmail" id="payerEmail"  value="{{ $rft->payerEmail ?? $customer->email }}">
                                            </div>
                                            <div class="mb-3">
