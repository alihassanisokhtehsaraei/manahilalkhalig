            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">New External Document</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <!-- Bookmark Start-->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5>NEW External DOCUMENT</h5><span>Here you can prepare a new external document based on our under controlled document systems.</span>
                        </div>
                        <form class="theme-form" method="post" action="{{ route('tdms.storeExternalDocument') }}" id="baNew" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <input  class="form-control" name="no" tabindex="3" value="{{ old('no') }}">
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="releaseDate" id="releaseDate" type="text" value="{{ old('releaseDate') }}">
                                            <span id="span1"></span>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="releaseDateGregorian" id="releaseDateGregorian" type="text" value="{{ old('releaseDateGregorian') }}">
