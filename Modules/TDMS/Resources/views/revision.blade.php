                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5>{{ $data->docType.'-'.$data->mgmtCode.'-'.$data->actCode.'-'.$data->no }}, Current Version: {{ $data->version }}</h5><span>You are preparing a new version for this document number, the next version will be {{ $data->version+1 }}, the current version will be withdraw automatically.</span>
                            <h6>New Version: {{ $data->version+1 }}</h6>
                        </div>
                        <form class="theme-form" method="post" action="{{ route('tdms.revisions',$data->id) }}" id="baNew" enctype="multipart/form-data">
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <select class="form-control" name="docType" style="display:inline;width:50px;" tabindex="2" disabled>
                                            ...
                                            <select class="form-control" name="mgmtCode" id="mgmtCode" style="display:inline;width:50px;" tabindex="2" disabled>
                                            ...
                                            <select class="form-control" id="activity" name="actCode" style="display:inline;width:53px;" tabindex="1"  disabled>
                                                <option value="{{ $data->actCode }}">{{ $data->actCode }}</option>
                                            </select> -
                                            <input  class="form-control" name="no" style="display:inline;width:100px;" tabindex="3" value="{{ $data->no }}" disabled>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="version" id="version" type="text"  placeholder="Document version like: 001" tabindex="4" value="{{ $data->version+1 }}">
                                        </div>


                                        <div class="mb-3">
                                            <label class="col-form-label pt-0" for="releaseDate">Release Date</label>
                                            <input class="form-control" name="releaseDate" id="releaseDate" type="text" >
                                            <span id="span1"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control"  name="native" id="native" type="file" >
                                        </div>
                                        <div class="mb-3">
