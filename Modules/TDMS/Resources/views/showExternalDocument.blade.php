                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5>External Document Profile</h5><span>Here you can modify all information related to this document.</span>
                        </div>
...
{{--                                        </div>--}}
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="col-form-label pt-0" for="pdf">PDF File <a class="btn btn-success btn-xs" href="{{ route('tdms.getExternalPdf', $data->id) }}" target='_blank'>Download File</a>
                                            </label>
