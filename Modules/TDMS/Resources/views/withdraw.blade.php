            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Withdraw Documents List</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <!-- Bookmark Start-->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5>Withdraw Documents List <a href="{{ route('tdms.create') }}" class="btn btn-sm btn-primary" style="float: right">New Document</a> </h5>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function () {
            $('#customers-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('tdms.getWithdrawList') !!}",
                columns: [
                    { data: 'DOC', name: 'DOC' },
