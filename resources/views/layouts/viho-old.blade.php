    ...
    <div class="page-body-wrapper sidebar-icon">
        ...
        <header class="main-nav">
            <div class="sidebar-user text-center"><a class="setting-primary" href="/user/profile"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{ asset('theme/viho/assets/images/dashboard/1.png')}}" alt="">
                <div class="badge-bottom"><span class="badge badge-primary">{{ auth()->user()->level  }}</span></div><a href="user-profile.html">
                    ...
                    <div id="mainnav">
                        <ul class="nav-menu custom-scrollbar">
                            ...
                            @if(Auth()->user()->department == 'Quality Development')
                                ...
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="file"></i><span>Document Center</span></a>
                                    <ul class="nav-submenu menu-content">
                                        ...
                                        @elseif(Auth()->user()->level == 'expert')
                                            <li><a href="{{ route('tdms.index') }}">Issued Documents</a></li>
                                        @endif
                                    </ul>
                                </li>
                            ...
                            @elseif(Auth()->user()->department == 'ICT')


                            @elseif(Auth()->user()->department == 'Inspection')

                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="search"></i><span>Inspection Dept.</span></a>
                                    <ul class="nav-submenu menu-content">
                                ...
                                <!--
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="mail"></i><span>Secretariat</span></a>
                                    <ul class="nav-submenu menu-content">
                                ...
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layers"></i><span>Accounting</span></a>
                                    <ul class="nav-submenu menu-content">
                                        <li><a href="">...</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="check-square"></i><span>Quality Development</span></a>
                                    <ul class="nav-submenu menu-content">
                                        <li><a href="">...</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="bar-chart"></i><span>Statistics</span></a>
                                    <ul class="nav-submenu menu-content">
                                        <li><a href="">...</a></li>
                                    </ul>
                                </li>
                                ...
                                -->
                                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="users"></i><span>Inspectors</span></a>
                                    <ul class="nav-submenu menu-content">
                                        <li><a href="{{ route('inspector.create') }}">New Inspector</a></li>
                                        <li><a href="{{ route('inspector.index') }}">Inspectors List</a></li>
                                    </ul>
                                </li>
                            @endif

                            <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="file"></i><span>Letters</span></a>
                                <ul class="nav-submenu menu-content">
                                    @if(Auth()->user()->level == 'secretary')
                                        <li><a href="{{ route('letter.reg') }}"><i class="icon-plus"></i> Reg Incoming Letter</a></li>
                                    @endif
                                    <li><a href="{{ route('letter.regIndex') }}"><i class="icon-import"></i> Letters index</a>
                                    <li><a href="{{ route('letter.search') }}"><i class="icon-search"></i> Search</a></li>
{{--                                    <li><a href="{{ route('letter.create') }}"><i class="icon-pencil-alt"></i> Compose</a></li>
                                    <li><a href="{{ route('letter.index', 'inbox') }}"><i class="icon-import"></i> Inbox</a></li>
                                    <li><a href="{{ route('letter.index', 'drafts') }}"><i class="icon-notepad"></i>  Drafts</a></li>
                                    <li><a href="{{ route('letter.index', 'sent') }}"><i class="icon-new-window"></i> Sent</a></li>--}}
                                </ul>
                            </li>
                            ...
                            @endif
                            @if(Auth()->user()->department =='Technical Inspection'))
                                <li><a class="nav-link menu-title link-nav" href="https://baranx.tie-co.com/ci"><i data-feather="database"></i><span>Baranx</span></a></li>
                            @endif
                            @if(Auth()->user()->department == 'Inspection')
                                <li><a class="nav-link menu-title link-nav" href="https://baranx.tie-co.com"><i data-feather="database"></i><span>Baranx</span></a></li>
                            @endif
                            <li><a class="nav-link menu-title link-nav" href="https://malix.tie-co.com"><i data-feather="database"></i><span>Malix</span></a></li>
                            <li><a class="nav-link menu-title link-nav" href="http://192.168.111.11:8080"><i data-feather="database"></i><span>WebCart</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">Copyright 2023 © Raymoon.io All rights reserved.</p>
                    </div>
                    <div class="col-md-6">
